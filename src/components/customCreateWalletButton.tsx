...
export function CustomCreateWalletButton() {
    ...
    return (
      <HoverCard>
        <HoverCardTrigger>
          ...
          >
            <RiStopCircleFill size={22} className='text-foreground' />&nbsp;
            <p className='text-foreground text-xs'>/</p>&nbsp;
            <CircleCheck size={22} className='text-main dark:text-white' />
          </Button>
        </HoverCardTrigger>
        <HoverCardContent className='bg-transparent border-none'>
  <Card className='text-sm font-medium mt-3 ml-2 p-3 bg-white dark:bg-main border-black leading-3'>
    <div className='flex items-center'>
      ...
      <Button size="sm" className="text-black dark:text-white ml-1">
        ...
        <RiStopCircleFill size={16} className='text-main dark:text-white ml-1' />
      </Button>
    </div>
  ...
  return (
    ...
    >
      <RiStopCircleFill size={22} className='text-foreground' />
      <p className="text-lg text-foreground font-semibold ml-1.5 pr-1.5">Create&nbsp;Wallet</p>
    </Button>
  );
}
